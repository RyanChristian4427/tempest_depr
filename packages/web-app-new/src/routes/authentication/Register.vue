<template>
    <form>
        <div class="field">
            <div class="control">
                <input class="input is-large" type="email" placeholder="Your First Name" v-model="state.firstName" />
            </div>
        </div>
        <div class="field">
            <div class="control">
                <input class="input is-large" type="email" placeholder="Your Last Name" v-model="state.lastName" />
            </div>
        </div>
        <div class="field">
            <div class="control">
...
export default defineComponent({
    ...
    setup() {
        ...
        function submit() {
            console.log('This would be registering');
        }
